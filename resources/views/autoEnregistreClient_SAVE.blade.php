			...
			<div class="row d-flex justify-content-center">
				...
				<div class="col-12 col-md-8">
					<div class="input-group flex-nowrap">
						...
						<input type="text" class="form-control @error('nom') is-invalid @enderror"  placeholder="Votre nom" name="nom" value="{{old('nom')}}">
					</div>
					...
					<div class="input-group flex-nowrap">
						...
						<input type="text" class="form-control @error('prenom') is-invalid @enderror"  placeholder="Votre prénom" name="prenom" value="{{old('prenom')}}">
					</div>
					...
					<div class="input-group flex-nowrap">
						...
						<input type="text" class="form-control @error('numero') is-invalid @enderror"  placeholder="Votre numéro" name="numero" id="numero" value="{{old('numero')}}" autocomplete="true">
					</div>
					...
					<div class="input-group flex-nowrap">
						...
						<input type="text" class="form-control @error('nce') is-invalid @enderror"  placeholder="Votre Numéro de carte etudiante" name="nce" value="{{old('nce')}}">
					</div>
						@error('numero') 
						<div class="invalid-feedbak">
							{{$errors->first('numero')}}
